...
export default function EditTeamPage(params: GetParams) {
    ...
    async function handleFileUpload(event: React.ChangeEvent<HTMLInputElement>) {
        if (event.target.files?.length) {
            ...
            setTableData((prev) => ({ ...prev, image: imageUrl }));        }
    }
            ...
            <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="relative z-20 h-35 md:h-65">
                    ...
                    <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
                        ...
                        >
                            <input type="file" onChange={(e) => handleFileUpload(e)} name="cover" id="cover" className="sr-only" />
                            <span>
                                <svg
                ...
                <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full ">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="font-medium">{tableData.position}</p>
                        <p className="font-medium">{tableData.department}</p>
